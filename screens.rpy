...
screen main_menu():
    ...
    imagemap:
        ...
        hover "gui/main_menu_use.png"

        hotspot(21, 161, 235, 58) action Start()
        hotspot(12, 260, 330, 56) action ShowMenu("load")
        hotspot(13, 360, 259, 66) action ShowMenu("about")
        hotspot(19, 655, 175, 58) action Quit(confirm=True)
        hotspot(1102, 657, 177, 46) action ShowMenu("help")
